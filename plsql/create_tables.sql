...
CONSTRAINT fk_employe FOREIGN KEY (employe) REFERENCES employe(id),
CONSTRAINT fk_client_hotel FOREIGN KEY (client_hotel) REFERENCES client_hotel(cin),
CONSTRAINT fk_chambre FOREIGN KEY (chambre) REFERENCES chambre(id_chambre),
