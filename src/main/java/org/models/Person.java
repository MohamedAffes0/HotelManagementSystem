...
public class Person extends Model{
	...
	public ArrayList<ModelField> getFields() {
		...
		data.add(new ModelField(getMail(), "mail-field-user", createIcon("M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z", 0.9, "#ffffff")));
