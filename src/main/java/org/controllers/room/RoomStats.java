...
public class RoomStats {
	...
	public static ArrayList<Room> getMostCovetedRooms(ArrayList<Room> rooms, ArrayList<Reservation> reservations) {
	...
	// Replace with actual reservation data

	// HashMap<Integer, Integer> reservationCount =
	// roomReservationCount(reservations);
	// System.out.println(reservationCount);

	// // Test the getMostCovetedRooms method
	// ArrayList<Room> rooms = RoomSelect.dataFromDB(); // Replace with actual room
	// data
	// ArrayList<Room> mostCovetedRooms = getMostCovetedRooms(rooms,
	// reservationCount);
