...
public class MainMenu implements Initializable {
	...
	@FXML
	// si le bouton "Statistiques" est pressé, chargez le fichier FXML pour le menu des statistiques
	void statsPressed(ActionEvent event) throws Exception {

		// charger le fichier FXML pour le menu des statistiques
	...
	@FXML
	// si le bouton "Chambres" est pressé, chargez le fichier FXML pour le menu des chambres
	void chambresPressed(ActionEvent event) throws Exception {
		...
		// changer le menu actuel pour le menu des chambres
	...
	@FXML
	// si le bouton "Clients" est pressé, chargez le fichier FXML pour le menu des clients
	void clientsPressed(ActionEvent event) throws Exception {
		...
		// changer le menu actuel pour le menu des clients
		changeCurrentMenu(controller,
				"Clients",
	...
	@FXML
	// si le bouton "Comptes" est pressé, chargez le fichier FXML pour le menu des comptes
	void comptesPressed(ActionEvent event) {
		...
		// changer le menu actuel pour le menu des comptes
		changeCurrentMenu(controller,
				"Comptes",
	...
	@FXML
	// si le bouton "Réservations" est pressé, chargez le fichier FXML pour le menu des réservations
	...
	@FXML
	// si le bouton "logout" est pressé, chargez le fichier FXML pour la page de connexion
	void logOutPressed(ActionEvent event) throws Exception {
		try {
			main.changeScene("/login.fxml"); // Changez la scène pour le fichier de connexion
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		// Définir l'icône pour le bouton "statistiques"
		...
		UiUtils.setIconToButton(stats, svgPath, 1, "#ffffff");

		// Définir l'icône pour le bouton "comptes"
		...
		UiUtils.setIconToButton(comptes, svgPath, 1, "#ffffff");

		// Définir l'icône pour le bouton "clients"
		...
		UiUtils.setIconToButton(clients, svgPath, 1, "#ffffff");

		// Définir l'icône pour le bouton "chambres"
		...
		UiUtils.setIconToButton(chambres, svgPath, 0.9, "#ffffff");

		// Définir l'icône pour le bouton "réservations"
		...
		UiUtils.setIconToButton(reservations, svgPath, 1, "#ffffff");

		// Définir l'icône pour le bouton "déconnexion"
		...
		main = new App(); // Créer une nouvelle instance de App pour changer la scène
	}
	
	void setNonAdmin() {
		// Remove the "Comptes" button from the menu
		((VBox) comptes.getParent()).getChildren().remove(comptes);
	}

	// Changer le menu actuel vers le contrôleur et les paramètres spécifiés
	private void changeCurrentMenu(ListScreen<?> controller, String title, ObservableList<String> filterItems,
		...
		try {
			...
			// Définir les paramètres du contrôleur
